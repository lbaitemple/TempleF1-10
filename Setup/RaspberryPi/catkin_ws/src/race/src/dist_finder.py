...
def getRange(data, theta):
	...
	"""
    carAngle = math.radians(theta) - math.pi / 2
    if carAngle > 3 * math.pi / 4:
        carAngle = 3 * math.pi / 4
    elif carAngle < -3 * math.pi / 4:
        carAngle = -3 * math.pi / 4

    float_index = (carAngle + 3 * math.pi / 4) / data.angle_increment
